...
Almost every processing units of an \expcode experiment has access to a structure named \mcode{config} which is imported from a file which is specific to each user. This file is created at the creation of the experiment from a user specific file that can be found in the \mcode{.expLord} directory in the home directory of the user.
