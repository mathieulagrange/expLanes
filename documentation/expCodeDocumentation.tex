...
Observations for the 2 processing steps are the following:

\lstinputlisting[firstline=24, lastline=24]{../demonstrations/geometricShape/gesh1base.m}

\lstinputlisting[firstline=25, lastline=25]{../demonstrations/geometricShape/gesh2space.m}

The command \mcode{geometricShape('f')} generates a diagram view of the experiment shown on Figure \ref{fig:diagram}.

\begin{marginfigure}
\includegraphics[width=\textwidth]{../demonstrations/geometricShape/report/figures/factors}
