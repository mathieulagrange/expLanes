function config = distanceDemonstration(varargin)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
% Welcome to the main entry point of distanceDemonstration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
% Please DO NOT modify this file unless you have a precise intent.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
shortProjectName = 'dide';                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
...
if configFile==-1,
    fprintf(2,['Unable to load the expLanes config file for your project named: ' configFileName '.']); return;
end
...
function [userDefaultConfigFileName userDir] = expUserDefaultConfig(expLanesPath)

if ~exist(expLanesPath), return; end % FIXME
...
if ~exist(userDefaultConfigFileName, 'file')
    ...
    copyfile([expLanesPath '/expLanesConfig.txt'], userDefaultConfigFileName);
else
