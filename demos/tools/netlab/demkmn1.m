...
%
%	A cluster settingl with three components is trained using the batch K-
...
clc 
disp('This demonstration illustrates the use of a cluster settingl to')
...
clc
disp('The settingl is chosen to have three centres, which are initialised')
disp('at randomly selected data points.  We now train the settingl using')
...
disp(' ')
disp('The trained settingl has centres:')
disp(centres);
disp('Press any key to continue.')
pause
