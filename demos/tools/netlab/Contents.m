...
% demgmm1  -  Demonstrate density settinglling with a Gaussian mixture settingl. 
% demgmm3  -  Demonstrate density settinglling with a Gaussian mixture settingl. 
% demgmm4  -  Demonstrate density settinglling with a Gaussian mixture settingl. 
% demgmm5  -  Demonstrate density settinglling with a PPCA mixture settingl. 
% demgp    -  Demonstrate simple regression using a Gaussian Process. 
% demgpard -  Demonstrate ARD using a Gaussian Process. 
% demgpot  -  Computes the gradient of the negative log likelihood for a mixture settingl. 
...
% demkmean -  Demonstrate simple clustering settingl trained with K-means. 
...
% glm      -  Create a generalized linear settingl. 
% glmderiv -  Evaluate derivatives of GLM outputs with respect to weights. 
% glmerr   -  Evaluate error function for generalized linear settingl. 
...
% glmtrain -  Specialised training of generalized linear settingl 
...
% gmmactiv -  Computes the activations of a Gaussian mixture settingl. 
% gmmem    -  EM algorithm for Gaussian mixture settingl. 
% gmminit  -  Initialises Gaussian mixture settingl from data 
% gmmpak   -  Combines all the parameters in a Gaussian mixture settingl into one vector. 
% gmmpost  -  Computes the class posterior probabilities of a Gaussian mixture settingl. 
% gmmprob  -  Computes the data probability for a Gaussian mixture settingl. 
% gmmsamp  -  Sample from a Gaussian mixture distribution. 
% gmmunpak -  Separates a vector of Gaussian mixture settingl parameters into its components. 
...
% gpinit   -  Initialise Gaussian Process settingl. 
...
% gtmlsetting -  Setting responsibility for data in a GTM. 
...
% kmeans   -  Trains a k means cluster settingl. 
...
% netopt   -  Optimize the weights in a network settingl. 
