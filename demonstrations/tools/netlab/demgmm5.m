...
%
%	A mixture designl with three one-dimensional PPCA components is trained
...
%	for the three components of the mixture designl together with the one
...
% Fit three one-dimensional PPCA designls
ncentres = 3;
ppca_dim = 1;
...
disp('The mixture designl has three components with 1-dimensional')
disp('PPCA subspaces.  The designl parameters after initialisation using')
...
disp('We now train the designl using the EM algorithm for up to 30 iterations.')
disp(' ')
disp('Press any key to continue.')
pause
