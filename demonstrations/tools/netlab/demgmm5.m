...
%
%	A mixture settingl with three one-dimensional PPCA components is trained
...
%	for the three components of the mixture settingl together with the one
...
% Fit three one-dimensional PPCA settingls
ncentres = 3;
ppca_dim = 1;
...
disp('The mixture settingl has three components with 1-dimensional')
disp('PPCA subspaces.  The settingl parameters after initialisation using')
...
disp('We now train the settingl using the EM algorithm for up to 30 iterations.')
disp(' ')
disp('Press any key to continue.')
pause
