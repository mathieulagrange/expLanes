...
%	components of the mixture settingl.
%
%	See also
...
disp(' ')
disp('The mixture settingl has three components and spherical covariance')
...
disp('We now train the settingl using the EM algorithm for 10 iterations')
disp(' ')
disp('Press any key to continue')
pause
...
disp('deviation, of the three components of the mixture settingl.')
disp(' ')
disp('Press any key to continue.')
pause
