...
%	components of the mixture designl.
%
%	See also
...
disp(' ')
disp('The mixture designl has three components and spherical covariance')
...
disp('We now train the designl using the EM algorithm for 10 iterations')
disp(' ')
disp('Press any key to continue')
pause
...
disp('deviation, of the three components of the mixture designl.')
disp(' ')
disp('Press any key to continue.')
pause
