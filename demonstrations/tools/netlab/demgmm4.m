...
%	three Gaussians in 2 dimensions with a mixture settingl using full
...
% Print out settingl
clc
disp('The mixture settingl has three components and full covariance')
...
disp('We now train the settingl using the EM algorithm for 50 iterations.')
disp(' ')
disp('Press any key to continue.')
pause
...
disp('    Priors        Centres')
disp([datap' datac])
disp('Settingl covariance matrices are')
disp(mix.covars(:, :, 1))
disp(mix.covars(:, :, 2))
disp(mix.covars(:, :, 3))
