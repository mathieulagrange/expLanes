...
%	three Gaussians in 2 dimensions with a mixture designl using full
...
% Print out designl
clc
disp('The mixture designl has three components and full covariance')
...
disp('We now train the designl using the EM algorithm for 50 iterations.')
disp(' ')
disp('Press any key to continue.')
pause
...
disp('    Priors        Centres')
disp([datap' datac])
disp('Designl covariance matrices are')
disp(mix.covars(:, :, 1))
disp(mix.covars(:, :, 2))
disp(mix.covars(:, :, 3))
