...
%	number of centres and target dimension for the  mixture designl whose
%	parameters are set from the outputs of the neural network. The fifth
%	argument MIXTYPE is used to define the type of mixture designl.
...
%	designl, the mixture coefficients are computed from a group of softmax
...
%	GMM) is used for the mixture designl outputs to improve the efficiency
...
%	  mdnmixes = data structure for mixture designl output
...
% Set up the mixture designl part of the structure
...
% Number of output nodes = number of parameters in mixture designl
