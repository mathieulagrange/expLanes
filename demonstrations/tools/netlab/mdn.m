...
%	number of centres and target dimension for the  mixture settingl whose
%	parameters are set from the outputs of the neural network. The fifth
%	argument MIXTYPE is used to define the type of mixture settingl.
...
%	settingl, the mixture coefficients are computed from a group of softmax
...
%	GMM) is used for the mixture settingl outputs to improve the efficiency
...
%	  mdnmixes = data structure for mixture settingl output
...
% Set up the mixture settingl part of the structure
...
% Number of output nodes = number of parameters in mixture settingl
