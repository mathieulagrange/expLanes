...
% You can compile the report by setting the option 'report' as detailed in your expLord configuration file. 
...
Please note the 2 between the first two equals of the factor definition of factor \mcode{distance} which specify that this factor is needed only for the second processing step. Most the factor design discussed above is compactly displayed in Figure \ref{factorFlowGraph}. Modalities\texttt{nbRealizations} and \texttt{nbElementsPerClass} are fixed.
