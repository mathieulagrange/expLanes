...
This document documents the first demonstration of the use of the expLord framework to conduct a computational experiment. The project clusteringDemonstration is about the comparison of several algorithms that clusters synthetic data.
