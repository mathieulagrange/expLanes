...
clc
disp('This demonstration illustrates the use of the Neuroscale settingl')
...
dstring = ['the Sammon mapping.  The settingl has ', num2str(ncentres), ...
    ' centres, two outputs, and uses'];
clc
disp('The Neuroscale settingl is an RBF with a Stress error measure as used in')
disp(dstring)
...
disp(' ')
disp('After training the settingl, we project the training data by a normal')
