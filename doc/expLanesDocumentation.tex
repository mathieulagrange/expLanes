...
An \explanes experiment can be controlled by editing the configuration file or overloading it with command line settings.

Each of those parameters can be accessed in the code of steps through the variable \mcode{config}. That is, in my 
...
\begin{itemize}
\item \textbf{probe}: probe tools, paths, and hosts
